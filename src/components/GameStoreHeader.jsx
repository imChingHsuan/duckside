         ...
         <nav>
            <ul>
               ...
               <g transform="translate(0 -56)">
                  <path id="Path_12" dataname="Path 12" d="M0,0H464.731L420.605,67.636,464.731,128H0Z" transform="translate(0 56)" fill="#50b6c2"/>
               ...
               <g id="我的積分Btn" transform="translate(-1355 -97)">
                  ...
                  <text id="_3000" data-name="3000" transform="translate(1493 163)" font-size="50" font-family="Helvetica-Bold, Helvetica" font-weight="700"><tspan x="0" y="0">
                     {totalPoints}
                  </tspan></text>
               ...
               <svg width="40" height="40" viewBox="0 0 84 84">
                  ...
                  <g id="關閉Btn" transform="translate(-1742 -29)">
                     ...
                     <path id="Icon_ionic-md-close" dataname="Icon ionic-md-close" d="M56.715,12.442,51.8,7.523,32.119,27.2,12.442,7.523,7.523,12.442,27.2,32.119,7.523,51.8l4.919,4.919L32.119,37.038,51.8,56.715,56.715,51.8,37.038,32.119Z" transform="translate(1751.881 38.881)" fill="#fff"/>
                  </g>
                  </a>
               </svg>
               </li>
